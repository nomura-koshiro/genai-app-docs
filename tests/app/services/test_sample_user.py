...
async def test_create_user_success(db_session, user_data):
    ...
    user_create = SampleUserCreate(**user_data)
...
async def test_create_user_duplicate_username(db_session, user_data):
    ...
    # 最初のユーザーを作成
    user_create1 = SampleUserCreate(**user_data)
    ...
    user_create2 = SampleUserCreate(**user_data2)
...
async def test_authenticate_user_success(db_session, user_data):
    ...
    # Act
    authenticated_user = await service.authenticate(user_data["email"], user_data["password"])
