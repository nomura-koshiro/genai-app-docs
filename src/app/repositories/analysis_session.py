...
class AnalysisSessionRepository(BaseRepository[AnalysisSession, uuid.UUID]):
    ...
    async def update_chat_history(self, session_id: uuid.UUID, chat_entry: dict[str, Any]) -> AnalysisSession | None:
        ...
        Args:
            ...
            chat_entry (dict[str, Any]): 追加するチャットエントリ
        ...
        # chat_historyに新しいエントリを追加
        current_history = session.chat_history or []
        updated_history = current_history + [chat_entry]
