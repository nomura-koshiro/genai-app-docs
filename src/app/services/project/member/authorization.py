...
使用例:
    >>> from app.services.project.member.authorization import ProjectMemberAuthorizationChecker
    >>>
...
class ProjectMemberAuthorizationChecker:
    ...
    async def get_requester_role(self, project_id: uuid.UUID, requester_id: uuid.UUID) -> ProjectRole:
        """リクエスタのロールを取得します。
    ...
    async def check_last_manager_protection(self, project_id: uuid.UUID, member: ProjectMember) -> None:
