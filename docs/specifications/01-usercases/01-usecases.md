...
| ID | ユースケース | 関連エンティティ |
|----|-------------|-----------------|
| UI-001 | 権限に応じたメニューを表示する | UserAccount |
| UI-002 | 参画プロジェクト数に応じて遷移先を切り替える | UserAccount, ProjectMember |

### 0.2 ヘッダー（コンテキスト）

| ID | ユースケース | 関連エンティティ |
|----|-------------|-----------------|
| UI-003 | ユーザーコンテキスト情報を取得する | UserAccount |

### 0.3 グローバル検索

| ID | ユースケース | 関連エンティティ |
|----|-------------|-----------------|
| UI-004 | プロジェクト・セッション・ファイル・ツリーを横断検索する | Project, AnalysisSession, ProjectFile, DriverTree |
| UI-005 | 検索結果をフィルタリングする | Project, AnalysisSession, ProjectFile, DriverTree |

### 0.4 ユーザー通知

| ID | ユースケース | 関連エンティティ |
|----|-------------|-----------------|
| UI-006 | 未読通知一覧を取得する | Notification, UserAccount |
| UI-007 | 通知詳細を取得する | Notification |
| UI-008 | 通知を既読にする | Notification |
| UI-009 | すべての通知を既読にする | Notification |
| UI-010 | 通知を削除する | Notification |
| UI-011 | 未読通知バッジを表示する | Notification, UserAccount |
