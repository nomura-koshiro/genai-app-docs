...
| **検索** | `/api/v1/search` | グローバル検索 | [10-search](../10-search/) |
| **通知** | `/api/v1/notifications/*` | ユーザー通知 | [11-notification](../11-notification/) |
| **システム管理** | `/api/v1/admin/*` | システム管理 | [12-system-admin](../12-system-admin/) |
